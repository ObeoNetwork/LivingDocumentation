...
public abstract class NamedElementImpl extends EObjectImpl implements NamedElement {
	...
	protected EClass eStaticClass() {
		return SpecificationPackage.Literals.NAMED_ELEMENT;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SpecificationPackage.NAMED_ELEMENT__NAME, oldName, name));
	}
	...
	public EList<Note> getNotes() {
		if (notes == null) {
			notes = new EObjectContainmentEList<Note>(Note.class, this, SpecificationPackage.NAMED_ELEMENT__NOTES);
		}
		return notes;
	}
