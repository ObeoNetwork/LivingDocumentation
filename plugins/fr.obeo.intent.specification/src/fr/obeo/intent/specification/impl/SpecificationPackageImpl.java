...
public class SpecificationPackageImpl extends EPackageImpl implements SpecificationPackage {
	...
	public void initializePackageContents() {
		...
		getFeature_RefFeatures().getEKeys().add(this.getNamedElement_Name());
		...
		getStory_As().getEKeys().add(this.getNamedElement_Name());
		...
		getStory_SoThat().getEKeys().add(this.getNamedElement_Name());
		...
		getStory_IWant().getEKeys().add(this.getNamedElement_Name());
		...
		getScenario_Given().getEKeys().add(this.getNamedElement_Name());
		...
		getScenario_When().getEKeys().add(this.getNamedElement_Name());
		...
		getScenario_Then().getEKeys().add(this.getNamedElement_Name());
		...
		getScenario_Values().getEKeys().add(this.getValue_Value());
		...
		getContext_Contexts().getEKeys().add(this.getNamedElement_Name());
