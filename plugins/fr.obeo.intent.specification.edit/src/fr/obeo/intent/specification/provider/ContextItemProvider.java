...
/**
 * This is the item provider adapter for a {@link fr.obeo.intent.specification.Context} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ContextItemProvider
	extends ScenarioElementItemProvider
	implements
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Context_contexts_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Context_contexts_feature", "_UI_Context_type"),
				 SpecificationPackage.Literals.CONTEXT__CONTEXTS,
				 true,
				 false,
				 true,
				 null,
