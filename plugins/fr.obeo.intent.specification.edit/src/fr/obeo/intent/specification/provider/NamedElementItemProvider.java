...
/**
 * This is the item provider adapter for a {@link fr.obeo.intent.specification.NamedElement} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class NamedElementItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 SpecificationPackage.Literals.NAMED_ELEMENT__NAME,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(SpecificationPackage.Literals.NAMED_ELEMENT__NOTES);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(NamedElement.class)) {
			case SpecificationPackage.NAMED_ELEMENT__NAME:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(SpecificationPackage.Literals.NAMED_ELEMENT__NOTES,
				 SpecificationFactory.eINSTANCE.createImplementationNote()));

		newChildDescriptors.add
			(createChildParameter
				(SpecificationPackage.Literals.NAMED_ELEMENT__NOTES,
				 SpecificationFactory.eINSTANCE.createTestNote()));

		newChildDescriptors.add
			(createChildParameter
				(SpecificationPackage.Literals.NAMED_ELEMENT__NOTES,
				 SpecificationFactory.eINSTANCE.createTestGenerationNote()));
	}
